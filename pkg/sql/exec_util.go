...
type ExecutorConfig struct {
	...
	InternalExecutorFactory iefactory.SessionBoundInternalExecutorFactory
}
...
func DescsTxn(
	...
	return cftxn.CollectionFactoryTxn(ctx, execCfg.CollectionFactory, execCfg.InternalExecutor, execCfg.DB, f)
}
