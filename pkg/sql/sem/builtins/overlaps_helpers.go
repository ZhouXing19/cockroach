...
var (
	validOverlapsOverloadVolatility = []OverlapsOverloadVolatility{
		...
		{[]*types.T{types.TimestampTZ, types.Interval, types.TimestampTZ, types.Interval}, tree.VolatilityImmutable},
...
// EvalOverlaps check if two intervals overlap, return a bool
