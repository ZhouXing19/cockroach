...
type GeneratedAsIdentityType int
const (
	GeneratedByDefault GeneratedAsIdentityType = iota
	GeneratedAlways
)
...
type ColumnTableDef struct {
	...
	Generated struct{
		IsGenerated bool
		GeneratedAsIdType GeneratedAsIdentityType
	}
	Hidden   bool
	Nullable struct {
...
func NewColumnTableDef(name Name, typRef ResolvableTypeReference, isSerial bool, qualifications []NamedColumnQualification, ) (*ColumnTableDef, error) {
	...
	for _, c := range qualifications {
		...
		case *GeneratedAlwaysAsIdentity:
			...
			d.Generated.GeneratedAsIdType = GeneratedAlways
		case *GeneratedByDefAsIdentity:
			d.Generated.IsGenerated = true
			d.Generated.GeneratedAsIdType = GeneratedByDefault
...
// GeneratedAs represents generated always as identity
