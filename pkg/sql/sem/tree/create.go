...
const (
	GeneratedAlways Generatedtype = iota
	GeneratedByDefault
)
...
func NewColumnTableDef(
	...
	for _, c := range qualifications {
		...
		case *GeneratedAlwaysAsIdentity:
			d.Generated.IsGenerated = true
			d.Generated.GeneratedType = GeneratedAlways
			d.Generated.ConstraintName = c.Name
			d.DisallowExplicitWrite = true
		case *GeneratedByDefAsIdentity:
			d.Generated.IsGenerated = true
			d.Generated.GeneratedType = GeneratedByDefault
			d.Generated.ConstraintName = c.Name
...
func (node *ColumnTableDef) Format(ctx *FmtCtx) {
	...
	if node.Generated.IsGenerated{
		switch node.Generated.GeneratedType {
		...
		if node.Generated.ConstraintName != ""{
			ctx.FormatNode(&node.Generated.ConstraintName)
		}
	}
