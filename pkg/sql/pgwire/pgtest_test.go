...
func TestJanePGTest(t *testing.T) {
	...
	if *flagAddr == "" {
		...
		pgtest.WalkWithNewServer(t, testutils.TestDataPath(t, "jane_test"), newServer)
	} else {
		pgtest.WalkWithRunningServer(t, testutils.TestDataPath(t, "jane_test"), *flagAddr, *flagUser)
	}
}
